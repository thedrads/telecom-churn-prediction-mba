...
A divisão 80/20 é um padrão amplamente aceito que:
- Fornece dados suficientes para treinamento (80%)
- Mantém conjunto de teste representativo (20%)
...
- **Dados:** Conjunto de teste (20% separado no início)
